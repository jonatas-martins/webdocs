...
function conferirPalpite() {
  ...
  if (palpiteUsuario === numeroAleatorio) {
    // se o numero estiver certo, texto parabenizando
...
function configFimDeJogo() {
  // funcao para quando o jogo finaliza (ganhou ou  acabou tentativa)
  ...
  botaoReinicio.setAttribute('class', 'botao-reinicio');
